...
//         <div className='flex items-center w-2/4	 h-2/4 bg-orange-400	 justify-around' id="mainBoxes">
...
//         </div>
//         </div>
//         <div className='flex justify-between absolute inset-x-0 end-0 ' id="footer">
...
//without the scroll bar error issue
